...
<div class="flex flex-col gap-[20px]">
    ...
    <?php $events = $events ?? []; foreach ($events as $event): ?>
        ...
        <div class="event-card bg-[#3A6CB5] rounded-[20px] overflow-hidden flex text-white h-[240px] shadow-sm transition-transform hover:scale-[1.01]"
            data-date="<?= $event['event_date'] ?>"
            data-category="<?= strtolower($event['category']) ?>"
            data-class="<?= strtolower($event['class_target']) ?>"
            data-req="<?= strtolower($event['requirement']) ?>">
            ...
            <div class="w-[70%] p-[25px] flex flex-col justify-center">
                ...
                <p class="text-[13px] text-gray-200 mb-[20px] leading-relaxed">
                ...
                <div class="grid grid-cols-2 gap-y-[15px] gap-x-[10px] text-[13px]">
                    ...
                    <div class="flex items-center gap-[12px]">
                        ...
                        <span>
                            <?= htmlspecialchars($event['class_target']) ?>
                        </span>
                    </div>
