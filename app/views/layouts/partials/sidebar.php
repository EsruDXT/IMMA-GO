<aside class="w-[140px] text-white p-[25px] flex-shrink-0 flex flex-col items-center">
    ...
    <ul class="text-center w-full">
        <li class="group flex flex-col items-center my-[30px] cursor-pointer text-white/80 hover:text-white transition-colors duration-300" onclick="window.location.href='/home'">
        ...
        <li
            class="group flex flex-col items-center my-[30px] cursor-pointer text-white/80 hover:text-white transition-colors duration-300"

            onclick="window.location.href='<?= ($_SESSION['user']['role'] === 'admin') ? '/admin/events' : '/events'; ?>'">
        ...
        <li class="group flex flex-col items-center my-[30px] cursor-pointer text-white/80 hover:text-white transition-colors duration-300"
            ...
            onclick="window.location.href='<?= ($_SESSION['user']['role'] === 'admin') ? '/admin/honors' : '/honors'; ?>'">
