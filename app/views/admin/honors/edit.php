...
<body class="bg-[#2D5DA1] font-[Arial] overflow-hidden">
    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 bg-[#F3F1EC] rounded-l-[50px] px-[50px] py-[35px] overflow-y-auto">
            ...
            <!-- FORM -->
            <form action="/admin/honors/update/<?= $honor['id']; ?>"
                method="POST"
                ...
                <div class="flex gap-[40px]">
                    ...
                    <div class="w-[42%]">
                        ...
                        <div
                            ...
                            <img id="previewImage"
                                src="/uploads/honors/<?= htmlspecialchars($honor['image']); ?>"
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mb-[25px]">
                            ...
                            <input type="text"
                                name="title"
                                value="<?= htmlspecialchars($honor['title']); ?>"
                                required
