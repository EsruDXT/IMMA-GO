        ...
        <form action="#" method="POST" enctype="multipart/form-data">
            <div class="grid grid-cols-12 gap-10">
                ...
                <div class="col-span-5 flex flex-col items-center">
                    <h2 class="text-2xl font-bold mb-4 text-gray-800 uppercase tracking-wide">Thumbnail Photo</h2>
                    <div class="w-[70%] aspect-square bg-white border-2 border-dashed border-gray-300 rounded-3xl flex flex-col items-center justify-center relative overflow-hidden shadow-sm">
                        ...
                        <label class="cursor-pointer bg-[#7495C6] text-white px-6 py-2 rounded-xl flex items-center space-x-2 z-10 hover:bg-blue-600 transition">
                ...
                <div class="col-span-7 space-y-4">
                    <div>
                        ...
                        <input type="text" name="title" placeholder="Title..." class="bg-[#F3F1EB] border border-[#A1A1A1] rounded-lg p-[10px] w-full">
                    </div>

                    <div>
                        <label class="block text-lg font-bold text-gray-800 mb-1">Description</label>
                        <textarea name="description" rows="4" placeholder="Description..." class="bg-[#F3F1EB] border border-[#A1A1A1] rounded-lg p-[10px] w-full resize-none"></textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="bg-white rounded-xl shadow-md p-4 border border-gray-200">
                                <div class="flex justify-between items-center bg-[#315E9E] text-white p-2 rounded-t-lg -m-4 mb-4">
                                    <i class="fa-solid fa-calendar-days"></i>
                                    <span class="text-sm font-bold">March 2026</span>
                                    <div class="space-x-2">
                                ...
                                <input type="date">
                                <div class="grid grid-cols-7 text-[10px] text-center gap-y-2">
                                    <span class="text-gray-400">Sun</span><span>Mon</span><span>Tue</span><span>Wed</span><span>Thu</span><span>Fri</span><span>Sat</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="organizer" placeholder="Name..." class="bg-[#F3F1EB] border border-[#A1A1A1] rounded-lg p-[10px] w-full">
                            </div>
                            <div>
                                <label class="block text-lg font-bold text-gray-800 mb-1">Location</label>
                                <input type="text" name="location" placeholder="Location..." class="bg-[#F3F1EB] border border-[#A1A1A1] rounded-lg p-[10px] w-full">
                            </div>
                            <div>
                                <label class="block text-lg font-bold text-gray-800 mb-1">Participants</label>
                                <input type="text" name="participants" placeholder="Participants.." class="bg-[#F3F1EB] border border-[#A1A1A1] rounded-lg p-[10px] w-full">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="absolute bottom-10 right-10">
                <button type="submit" class="bg-[#7495C6] text-white px-16 py-3 rounded-xl text-xl font-bold shadow-lg hover:bg-blue-600 transition">
                    Add
                </button>
            </div>
        </form>
